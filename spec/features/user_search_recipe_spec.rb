...
feature 'visitor searches recipe and' do
  ...
  #
  #   recipe_one = Recipe.create(title: 'Frango assado', recipe_type: 'Prato Principal',
  #                         cuisine: cuisine_one, difficulty: 'Médio',
  #                         cook_time: 60,
  #                         ingredients: 'galo e alho',
  #                         method: 'Coloque o frango no forno e espere dourar')
  #   recipe_two = Recipe.create(title: 'Chicken a parmegiana', recipe_type: 'Prato Principal',
  ...
  #
  #   recipe_three = Recipe.create(title: 'Bolo de cenoura', recipe_type: 'Sobremesa',
  #                              cuisine: cuisine_one, difficulty: 'Médio',
  #                              cook_time: 60,
  ...
  #   expect(page).to have_css('li', text: recipe_one.recipe_type)
  ...
  #   expect(page).to have_css('li', text: recipe_two.recipe_type)
